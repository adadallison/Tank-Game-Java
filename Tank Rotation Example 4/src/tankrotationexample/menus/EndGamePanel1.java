...
public class EndGamePanel1 extends JPanel {
    ...
    public EndGamePanel1(Launcher lf) {
        this.lf = lf;
        try {
            menuBackground = ImageIO.read(this.getClass().getClassLoader().getResource("gameover1.png")); //the title for Tank Wars
        } catch (IOException e) {
